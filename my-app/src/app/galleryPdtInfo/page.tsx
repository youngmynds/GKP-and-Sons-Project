    ...
    <div className="bg-[#FFFCF8]">
      ...
      <div className="md:flex p-4 justify-center items-center mt-5">
        ...
        <div className="md:w-[30%] justify-center md:ml-10 mt-5 md:mt-0">
          ...
          >
            This exquisite casting gold ring is a masterpiece of craftsmanship,
            blending tradition with modern artistry. Radiating a brilliant
            golden luster, its intricate details highlight the precision of
            expert artisanship. Whether adorned with delicate engravings or left
            in its pure, minimalist form, this ring exudes sophistication and
            charm.
          </p>
        </div>
      </div>
