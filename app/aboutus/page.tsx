...
export default function AboutUs() {
    ...
    const milestones = isTamil
        ? [
              {
                  title: "அசைக்க முடியாத கைவினைப்பணி",
                  description:
                      "எங்கள் நகைகள் பாரம்பரியத்தையும் நவீன நேர்த்தியையும் ஒருங்கிணைத்து உருவாக்கப்படுகின்றன.",
              },
              {
                  title: "அற்புதமான வடிவமைப்புகள்",
                  description:
                      "கிளாசிக் பாரம்பரிய வடிவங்கள் முதல் நவீன சுவைகள்வரை, அனைத்து தருணங்களுக்கும் பொருந்தும் வகையில் வடிவமைக்கப்பட்டுள்ளது.",
              },
              {
                  title: "நம்பிக்கைக்குரிய உறவுகள்",
                  description:
                      "நேர்மை மற்றும் வெளிப்படைத்தன்மையுடன், எங்கள் வாடிக்கையாளர்களுடன் உறுதியான உறவுகளை உருவாக்குகிறோம்.",
              },
              {
                  title: "உத்தரவாத தரம்",
                  description:
                      "சுத்தமான தங்கம் மற்றும் வைரத்துடன், எங்கள் நகைகள் சிறப்பாக வடிவமைக்கப்படுகின்றன.",
              },
          ]
        : [
              {
                  ...
                  description:
                      "Our jewellery is crafted with precision and artistry, using only the finest materials to create timeless pieces that blend tradition and contemporary elegance.",
              },
              {
                  title: "Exquisite Designs",
                  description:
                      "We offer a diverse collection that caters to every occasion, from classic heritage designs to modern creations that reflect evolving trends.",
              },
              {
                  title: "Trusted Relationships",
                  description:
                      "Integrity and transparency define our approach. We build lasting relationships with our customers through ethical practices and genuine service.",
              },
              {
                  title: "Guaranteed Quality",
                  description:
                      "With a commitment to purity and excellence, we ensure ethical sourcing and rigorous quality checks, delivering only the finest jewellery to our valued customers.",
              },
          ];
            ...
            <div className="max-w-5xl mx-auto py-16 px-8 justify-center items-center pb-20">
                <div className="mt-4 mb-4">
                    <label className="flex items-center cursor-pointer">
                        <span
                            className={`mr-2 ${dancingScript.className} ${isTamil ? "text-gold" : "text-gold"} text-2xl`}
                        >
                            English
                        </span>
                        <input
                        ...
                        />
                        <div
                            className={`w-10 h-6 ${isTamil ? "bg-gold" : "bg-gray-300"} rounded-full p-1 relative ml-4`}
                        >
                            <div
                                className={`w-4 h-4 -mt-[1.px] bg-white rounded-full shadow-md transform ${isTamil ? "translate-x-5" : "translate-x-0"} transition-transform`}
                            ></div>
                        </div>
                        <span
                            className={`ml-6 ${dancingScript.className} ${isTamil ? "text-gold" : "text-gold"} text-2xl`}
                        >
                            Tamil
                        </span>
                    </label>
                ...
                <div className="relative border-l-4 border-gold pl-6 mt-10">
                    {milestones.map((item, index) => (
                        <div key={index} className="mb-8 relative">
                            ...
                            <h3
                                className={`text-3xl text-gold font-bold ${dancingScript.className}`}
                            >
                                {item.title}
                            </h3>
                            <p
                                className={`text-gray-600 text-base md:text-lg ${cardo.className}`}
                            >
                                {item.description}
                            </p>
                        </div>
